...
module.exports = async ({ getNamedAccounts, deployments }) => {
  ...
  log("Deploying ConquerStudents and waiting for confirmations...");

  // Deploy the 'ConquerStudents' contract
  const conquerStudents = await deploy("ConquerStudents", {
  ...
  log(`ConquerStudents deployed at ${conquerStudents.address}`);
  ...
  if (
    ...
    await verify(conquerStudents.address, []);
  }
};

// Module tags to identify and group different deployment scripts
module.exports.tags = ["all", "conquerStudents"];
